...
# def generate(info):
#     random_index1 = random.randint(0, len(info) - 1)
#     person = info[random_index1]
...
#
#
# random_people1 = generate(data)
# random_people2 = generate(data)
#
# Comparison = input("Who has more followers? Type 'A' or 'B': ").upper()
# if Comparison == 'A' or Comparison == 'B':
#     print(f'Compare A: {random_people1}')
#     print(f'Compare B: {random_people2}')
